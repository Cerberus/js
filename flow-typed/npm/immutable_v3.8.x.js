 ...
 * When referring to those types, you can  the proper definitions by
...
declare module 'immutable' {
  ...
  declare class _Iterable<K, V, KI, II, SI> {
    ...
    get(key: K): any;
    // get(key: K): V;
    get<V_>(key: K, notSetValue: V_): any;
    ...
    getIn<T>(searchKeyPath: ESIterable<any>, notSetValue: T): any;
    // getIn<T>(searchKeyPath: ESIterable<any>, notSetValue: T): T;
    getIn<T>(searchKeyPath: ESIterable<any>): any;
